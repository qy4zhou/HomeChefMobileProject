...
-(void)pluginInitialize
{
...

    {
        ...
        NSString *docs = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSrecipeDomainMask, YES) objectAtIndex: 0];
        NSLog(@"Detected docs path: %@", docs);
        [appDBPaths setObject: docs forKey:@"docs"];

        NSString *libs = [NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSrecipeDomainMask, YES) objectAtIndex: 0];
