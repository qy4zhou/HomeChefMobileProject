  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': Basic sql tx test(s)', function() {
      ...
      var openDatabase = function(name, ignored1, ignored2, ignored3) {
        ...
        if (isWebSql) {
          return sqlitePlugin.openDatabase(name, '1.0', 'Test', DEFAULT_SIZE);
        } else {
          ...
          db.transaction(function(tx) {
            ...
            tx.executeSql('INSERT INTO recipes (data, data_num) VALUES (?,?)', ['test', 100], function(tx, res) {
              ...
              db.transaction(function(tx) {
                ...
                tx.executeSql('SELECT data_num FROM recipes;', [], function(tx, res) {
                  ++check_count;
                ...
                tx.executeSql('SELECT data FROM recipes;', [], function(tx, res) {
                  ++check_count;
                ...
                tx.executeSql('UPDATE recipes SET data_num = ? WHERE data_num = 100', [101], function(tx, res) {
                  ++check_count;
                ...
                tx.executeSql("DELETE FROM recipes WHERE data LIKE 'tes%'", [], function(tx, res) {
                  ++check_count;
